...
firewall-cmd --permanent --service=zabbix --set-short="Zabbix Service Ports"
firewall-cmd --permanent --service=zabbix --set-description="Zabbix service firewalld port exceptions"
firewall-cmd --permanent --service=zabbix --add-port=3000/tcp
